                ...
                <nav>
                    ...
                    <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
                        ...
                        <li class="text-sm pl-2 capitalize leading-normal text-black before:float-left before:pr-2 before:text-black before:content-['/']"
                            aria-current="page">SOP Layanan Umum</li>
                    </ol>
                    <h6 class="mb-0 font-bold text-black capitalize">SOP Layanan Umum</h6>
                </nav>
        ...
        <div class="w-full px-10 mt-9 mx-auto">
            <div class="flex flex-row flex-wrap my-10 justify-center sm:justify-evenly">
                ...
                <div class="flex flex-col justify-center mb-5 mx-5 bg-white rounded-2 p-4 border-2 w-75">
                    ...
                    <p class="text-center font-semibold mb-4">Peminjaman sarana dan prasarana</p>
                    <a href="./adminEditSOP.php?id=17"   class="w-full text-center mb-4 py-2 rounded-1 bg-[#263959] hover:bg-[#EBA92E] text-white" >Edit</a>
                </div>

                <div class="flex flex-col justify-center mb-5 mx-5 bg-white rounded-2 p-4 border-2 w-75">
                    <img src="../assets/img/gov.png" alt="iconLayanan" class="w-14 h-14 mx-auto mb-4">
                    <p class="text-center font-semibold mb-4">Permintaan Barang</p>
                    <a href="./adminEditSOP.php?id=18"   class="w-full text-center mb-4 py-2 rounded-1 bg-[#263959] hover:bg-[#EBA92E] text-white" >Edit</a>
                </div>
            </div>
        </div>
    </main>

            ...
            <div class="flex bg-white h-14 px-3 items-center justify-between overflow-x-auto overflow-y-clip">
                ...
                <div id="myModal1"
                    ...
                    <div class="bg-white w-full h-full p-5 rounded overflow-auto">
                        ...
                        <!-- Modal Body -->
                        <!-- tambah akun -->
                        <form action="../proses/prosesadduser.php" method="POST">
                        <div>
                            
                            <h1 class="text-2xl font-bold mb-4">Menambah Akun User</h1>
                            <div class="px-0 md:px-7 lg:px-16">
                                <div class="flex flex-wrap w-full justify-between px-2 xl:px-7 mb-5">
                                    ...
                                    <input type="text" name="nim" class="flex border h-8 w-full md:w-3/4 pl-2 rounded-1">
                                </div>
                                <div class="flex flex-wrap w-full justify-between px-2 xl:px-7 mb-5">
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                ?> 
                        <tr class="<?= $row_class ?>  border-b">
                            ...
                            <a href="./SuperUserEdit.php?nim=<?= $row["nim"] ?>" class="mr-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                ...
                                <a href="../proses/prosesdeleteuser.php?nim=<?= $row["nim"] ?>" class="mr-2">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
